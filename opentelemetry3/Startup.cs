...
namespace opentelemetry3
{
    ...
    {
        public static readonly ActivitySource MyActivitySource = new("opentelemetry3.Startup.*");
        ...
        private static void Configure(WebApplication app)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapGet("/weatherforecast", async context =>
                {
                    ...
                    await context.Response.WriteAsync("hello from opentelemetry3");
                });
            });
        }
    }
